...
LABEL mantainer="Peng Xiao <xiaoquwl@gmail.com>"
...
RUN pip install --upgrade pip \
    && pip install --no-cache-dir jupyter pandas matplotlib scipy seaborn


RUN mkdir -p /opt/build/notebooks
WORKDIR /opt/build/notebooks

EXPOSE 8888

VOLUME ["/opt/build/notebooks"]
